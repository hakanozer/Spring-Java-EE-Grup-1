...
public class LoginController {
	...
	public String userLogin(User user) {
		 ...
		 * for (User item : uls) { if (item.getMail().equalsIgnoreCase(user.getMail())
		 * && item.getPass().equalsIgnoreCase(user.getPass())) { return
		 * "redirect:/dashboard"; } else { System.out.println("Login Fail"); } }
		 */
